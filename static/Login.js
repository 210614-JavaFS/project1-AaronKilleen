...
let managerMenuPage = document.createElement("div");
let employeeMenuPage = document.createElement("div");
let addReimbursementPage = document.createElement("div");
let resolveReimbursementPage = document.createElement("div");
...
async function loginRequest()
{
  ...
  if(response.ok)
	...
	message = responseContainer.message;
	checkState();
	}else{
